 ...
 stage('Install Dependencies') {
    ...
    stage('Docker Build and Push') {
     ...
     stage('Update Image Tag in GitOps') {
      steps {
         checkout scmGit(branches: [[name: '*/master']], extensions: [], userRemoteConfigs: [[credentialsId: 'git-ssh', url: 'git@github.com:udemy-dev-withK8s-AWS-codedecode/food-delivery-app-FE.git']])
        script {
